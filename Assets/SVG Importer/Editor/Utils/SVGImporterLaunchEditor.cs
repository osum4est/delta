    ...
    public class SVGImporterLaunchEditor {
        ...
        */
        ...
        public static void OnSceneGUI(SceneView sceneView)
        {
            ...
            SVGAsset asset = svgAssetsFromDraggedPathsOrObjects[0];
            if (asset == null)
            {
                return;
            }
            ...
            if (type == EventType.DragPerform)
            {
                ...
                point.z = 0f;
                GameObject objectToUndo = DropFramesToSceneToCreateGO(asset.name, svgAssetsFromDraggedPathsOrObjects, point);
