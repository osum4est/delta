...
namespace SVGImporter.Rendering 
{
    ...
    public class SVGLineElement : SVGParentable, ISVGDrawable
    {
        ...
        static void CreateStroke(SVGLineElement svgElement)
        {
            ...
            List<List<Vector2>> stroke = SVGSimplePath.CreateStroke(SVGGraphics.position_buffer, svgElement.paintable, false);
