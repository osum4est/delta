...
namespace SVGImporter.Rendering
{
    ...
    public class SVGSimplePath {
        ...
        public static StrokeSegment[] GetSegments(List<Vector2> points)
        {
            ...
            if(segments.Count > 1 && segments[0].startPoint == segments[segments.Count - 1].endPoint)
            {
        ...
        public static List<List<Vector2>> CreateStroke(List<Vector2> inputShapes, SVGPaintable paintable, bool closePath = false)
        {
        ...
        public static List<List<Vector2>> CreateStroke(List<List<Vector2>> inputShapes, SVGPaintable paintable, bool closePath = false)
        {
            if(inputShapes == null || inputShapes.Count == 0 || paintable == null || paintable.strokeWidth <= 0f)
                return null;
        ...
        public static Mesh CreateStrokeMesh(List<Vector2> inputShapes, SVGPaintable paintable, bool closePath = false)
        {
            if(inputShapes == null || inputShapes.Count == 0 || paintable == null || paintable.strokeWidth <= 0f)
                return null;
        ...
        public static Mesh CreateStrokeMesh(List<List<Vector2>> inputShapes, SVGPaintable paintable, bool closePath = false)
        {
            if(inputShapes == null || inputShapes.Count == 0 || paintable == null || paintable.strokeWidth <= 0f)
                return null;
        ...
        public static Mesh CreateStrokeSimple(SVGPaintable paintable, bool closePath = false)
        {
            return CreateStrokeSimple(new List<List<Vector2>>(){new List<Vector2>(SVGGraphics.position_buffer.ToArray())}, paintable, closePath);
        }

        public static Mesh CreateStrokeSimple(List<List<Vector2>> inputShapes, SVGPaintable paintable, bool closePath = false)
        {
            if(inputShapes == null || inputShapes.Count == 0 || paintable == null || paintable.strokeWidth <= 0f)
                return null;
